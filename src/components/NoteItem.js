    ...
    <Row>
      ...
      <Col xs={12}>
        {note.content.map((line, i) => {
          return (
            <p style={styleText} key={note.title + 'content' + i}>
              {line}
            </p>
          );
        })}
        ...
        <Col xs={12} md={4}>
          ...
          <div>
            {note.summary.map((line, i) => {
              return (
                <p style={styleText} key={note.title + 'summary' + i}>
                  {line}
                </p>
              );
            })}
        ...
        <Col xs={12} md={4}>
          ...
          <ul>
            {note.needs.map((line, i) => {
              return (
                <li style={styleText} key={note.title + 'needs' + i}>
                  {line}
                </li>
              );
            })}
        ...
        <Col xs={12} md={4}>
          ...
          <div>
            {note.solution.map((line, i) => {
              return (
                <p style={styleText} key={note.title + 'solution' + i}>
                  {line}
                </p>
              );
            })}
