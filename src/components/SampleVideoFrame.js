...
const SampleVideoFrame = ({ src, screenSize, pos, isMouseOver }) => {
  ...
  const styles = {
    ...
    position: 'absolute',
    top: pos.y,    // computed based on child and parent's height
    left: pos.x   // computed based on child and parent's width
  };
